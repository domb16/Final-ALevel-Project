...
public class Matrix2D
{
    ...
    public Matrix2D abs()
    {
        return abs( new Matrix2D() );
    }

    /**
     * Sets out to the absolute value of this matrix.
     */
    public Matrix2D abs( Matrix2D out )
    {
     ...
     */
    public Matrix2D transpose( Matrix2D out )
    {
        out.m00 = m00;
        out.m01 = m10;
        out.m10 = m01;
     ...
     */
    public Matrix2D mul( Matrix2D x, Matrix2D out )
    {
     ...
     */
    public Matrix2D mul( Matrix2D x )
    {
        return mul( x, new Matrix2D() );
    }
